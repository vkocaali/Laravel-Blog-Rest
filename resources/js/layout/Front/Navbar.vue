<template>
    ...
    <nav class="bg-white shadow fixed max-w-screen-lg mx-auto z-10 mx-auto inset-x-0 top-0 flex justify-between items-center">

        <a href="#" class="font-extrabold m-3 inline-flex hover:text-pink-700 transition-all duration-500">
        ...
        <!-- List of nav item -->
        <div id="sideMenuHideOnMobile" class="bg-white z-10 rounded-bl-md flex absolute top-0 right-0 transition-all duration-500 transform translate-x-0
                                              w-1/2 md:w-auto
                                              px-3 md:px-0
                                              flex-col md:flex-row
                                              -translate-y-full md:translate-y-0
                                              md:mt-1 md:items-center md:mx-1 ">
            <a href="#" class="mx-0 sm:mx-2 my-2 border-b-2 border-transparent hover:border-pink-600 hover:text-pink-700 transition-all duration-500 py-1 sm:p-0">Hakkımda</a>
            <a href="#" class="mx-0 sm:mx-2 my-2 border-b-2 border-transparent hover:border-pink-600 hover:text-pink-700 transition-all duration-500 py-1 sm:p-0">İletişim</a>
            <a href="#" class="mx-0 sm:mx-2 my-2 border-b-2 border-transparent hover:border-pink-600 hover:text-pink-700 transition-all duration-500 py-1 sm:p-0">Blog</a>
        </div>
