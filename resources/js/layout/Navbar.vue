    ...
    <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
        ...
        <div class="flex items-center">
            <div class="relative">
                ...
                <div @click="notificationOpen = false"
            ...
            <div class="relative">
                <button @click="dropdownOpen = !dropdownOpen"
                    ...
                    <img class="h-full w-full object-cover"
                         :src="`https://ui-avatars.com/api/?background=63B3ED&color=fffff&name=%${loggedUser.name}`"
                         :alt="loggedUser.name">
                </button>

                <div @click="dropdownOpen = false" class="fixed inset-0 h-full w-full z-10"
                     style="display: none;"></div>

                <div v-if="dropdownOpen"
                     class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10">
                    <a @click="logout"
                       class="block px-4 py-2 text-sm hover:bg-indigo-600 hover:text-white">Çıkış Yap</a>
                </div>
            </div>
        </div>
    </header>
        ...
        methods: {
            ...
            getLoggedUser(){
                ...
                axios.get('/user',{
                    ...
                    this.$store.dispatch('setLoggedUser',response.data);
                }).catch(err => {
