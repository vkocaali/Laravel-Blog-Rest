        ...
        <div class="mt-8">
            <div class="mt-4">
                <div class="p-6 bg-white rounded-md shadow-md">
                    ...
                    <h2 class="text-lg text-gray-700 font-semibold capitalize">Yeni Yazı Ekleme</h2>


                    <form v-on:submit.prevent="createArticleSubmit">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                            <div
                                ...
                                <input v-model="createArticles.title" @keyup="sanitizeTitle(createArticles.title)"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-4">
                            ...
                            <div
                                ...
                                <select v-model="createArticles.categories_id" id="categories_id" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
                            ...
                            <div
                                ...
                                <select v-model="createArticles.author_id" id="author_id" class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
    ...
    export default {
        ...
        methods: {
            ...
            sanitizeTitle: function(title) {
                ...
                slug = slug.replace(/\s+/g, '-');
                this.createArticles.slug = slug;
            },
            createArticleSubmit : function(){
                this.loading = false;
                const token = localStorage.getItem('token');
                axios({
                    url: `/articles`,
                    method: "POST",
                    data: this.createArticles,
                    headers: {Authorization: `Bearer ${token}`},
                }).then(response => {
                    this.loading = true;
                    this.errors = null;
                    this.status = response.status;
                    this.$router.push({name : 'yonetim.yazilar'});
                    this.$notify(
